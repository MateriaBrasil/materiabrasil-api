  ...
  [
    {
      ...
      options: [
        ...
        {
          value: 3,
          description: 'Rede elétrica municipal (ao menos 10% da energia é oriunda de fontes renováveis tais como energia solar, eólica)'
        },
        {
          value: 4,
          description: '100% de fontes renováveis (Eólica, solar, hidrelétricas de pequeno porte ou sem barragens, Biomassa....)'
        },
        {
          value: 5,
          description: '100% de fontes renováveis autossuficientes (produção própria)'
        }
      ]
    },
    {
      ...
      options: [
        ...
        {
          value: 4,
          description: 'Já implementamos processos e tecnologias que visam a redução do consumo'
        },
        {
          value: 5,
    ...
    },
    {
      ...
      options: [
        ...
        {
          value: 4,
          description: 'Já implementamos processos e tecnologias que visam a redução do consumo, como por exemplo: Torneiras, banheiros e chuveiros de fluxo reduzido de água'
        },
        {
          value: 5,
          description: 'Além da redução contamos com iniciativas de Coleta de Água da chuva e Reutilização/reciclagem da água cinza.'
        }
      ]
    },
    {
    ...
    },
    {
      ...
      options: [
        ...
        {
          value: 3,
          description: 'Serviço contratado de terceiros (certificada e pode fornecer documentação para descarte responsável)'
        },
        {
          value: 4,
          description: 'Os resíduos são separados para a reciclagem e doados / fornecidos a outras instituições desde que coletem no local (certificada e pode fornecer documentação para descarte responsável)'
        },
        {
          value: 5,
          description: 'Os resíduos são separados e reciclados / reutilizados para a produção própria da empresa ou encaminhados para cooperativas de reciclagem.'
        }
      ]
    },
    {
      ...
      options: [
        ...
        {
          value: 5,
          description: 'Não geramos resíduos perigosos'
        }
      ]
    },
    {
      ...
      options: [
        ...
        {
          value: 3,
          description: 'Temos princípios de redução do desperdício e produção mais limpa para a todo o processo produtivo'
        },
        {
          value: 4,
          description: 'Temos um programa de redução e já conseguimos reduzir em até 50% os nossos resíduos'
        },
        {
          value: 5,
          description: 'Temos um programa de redução e já conseguimos reduzir em mais de 50% os nossos resíduos gerados'
        }
      ]
    },
    {
      ...
      options: [
        ...
        {
          value: 3,
          description: 'Temos princípios de reciclagem e reuso para a todo o processo produtivo'
        },
        {
          value: 4,
          description: 'Temos um programa de reuso e reciclagem e já conseguimos encaminhar pra reciclagem 50% dos nossos resíduos'
        },
        {
          value: 5,
          description: 'Temos um programa de reuso e reciclagem e já conseguimos encaminhar pra reciclagem mais de 50% do nossos nossos resíduos'
        }
      ]
    },
    {
      ...
      options: [
        ...
        {
          value: 3,
          description: 'Possuo uma cadeia de fornecedores'
        },
        {
          value: 5,
          description: 'Produto resultante de colaborações multi laterais e Open Source (aberta)'
        }
      ]
    },
    {
      ...
      options: [
        ...
        {
          value: 3,
          description: 'o meu produto possui tecnologia que permite a sua reciclagem e nos locais onde ele é comercializado existem iniciativas privadas que já fazem sua reciclagem'
        },
        {
          value: 4,
          description: 'o meu produto possui tecnologia que permite a sua reciclagem e nos locais onde ele é comercializado a coleta de lixo pública o separa e encaminha para reciclagem'
        },
        {
          value: 5,
          description: '100% dos meus produtos são reciclados atendidos pela logística reversa, sob responsabilidade nossa ou de terceiros.'
        }
      ]
    },
    {
      ...
      options: [
        ...
        {
          value: 5,
          description: 'Processo produtivo manual, artesanal'
        }
      ]
    },
    {
      ...
      options: [
        ...
        {
          value: 4,
          description: 'Já implementamos processos e tecnologias que visam a redução do consumo, como por exemplo: Lampadas de led, equipamentos com selos de eficiência..'
        },
        {
          value: 5,
          description: 'Além das tecnologias que visam a redução de consumo energético, fizemos modificações nosso escritório visano a ventilação natural, iluminação passiva e geração de energia limpa.'
        }
      ]
    }
  ]
