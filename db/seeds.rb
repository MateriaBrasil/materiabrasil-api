...
cat1_child1 = category1.children.create!(name: 'Compósitos', multiple_choice: false)
cat1_child1.children.create!(name: 'Naturais')
cat1_child1.children.create!(name: 'Sintéticos')
cat1_child1.children.create!(name: 'Mixto')
cat1_child2 = category1.children.create!(name: 'Cerâmicos', multiple_choice: false)
...
cat1_child3 = category1.children.create!(name: 'Poliméricos', multiple_choice: false)
cat1_child3_child1 = cat1_child3.children.create!(name: 'Plásticos', multiple_choice: false)
cat1_child3_child1.children.create!(name: 'Naturais')
cat1_child3_child1.children.create!(name: 'Sintéticos')
cat1_child3_child2 = cat1_child3.children.create!(name: 'Fibras', multiple_choice: false)
cat1_child3_child2.children.create!(name: 'Naturais')
cat1_child3_child2.children.create!(name: 'Sintéticos')
cat1_child3_child3 = cat1_child3.children.create!(name: 'Borracha', multiple_choice: false)
cat1_child3_child3.children.create!(name: 'Naturais')
cat1_child3_child3.children.create!(name: 'Sintéticos')
category1_child4 = category1.children.create!(name: 'Metálicos', multiple_choice: false)
...
cat2_child1.children.create!(name: 'outro (texto corrido)')

cat2_child2 = category2.children.create!(name: 'processos materiais poliméricos')
...
cat2_child4_child8 = cat2_child4.children.create!(name: 'Demais beneficiamentos')
cat2_child4_child8.children.create!(name: 'Crackant')
cat2_child4_child8.children.create!(name: 'Wash and wear')
cat2_child4_child8.children.create!(name: 'Antifogo')
cat2_child4_child8.children.create!(name: 'Antimanchas')
cat2_child4_child8.children.create!(name: 'Antiestáticos')
cat2_child4_child8.children.create!(name: 'Anti Microorganismos')
cat2_child4_child8.children.create!(name: 'Anti parasitas')
cat2_child4_child8.children.create!(name: 'Antirruga')
cat2_child4_child8.children.create!(name: 'Aplicação de amaciantes')
cat2_child4_child8.children.create!(name: 'Aplicação de encorpantes')
cat2_child4_child8.children.create!(name: 'Calandragem')
cat2_child4_child8.children.create!(name: 'Carregamento')
cat2_child4_child8.children.create!(name: 'Escovagem')
cat2_child4_child8.children.create!(name: 'Flanelagem')
cat2_child4_child8.children.create!(name: 'Gofragem')
cat2_child4_child8.children.create!(name: 'Hidrofugação')
cat2_child4_child8.children.create!(name: 'Impermeabilização')
cat2_child4_child8.children.create!(name: 'Lixagem')
cat2_child4_child8.children.create!(name: 'Moiré')
cat2_child4_child8.children.create!(name: 'Pré-encolhimento')
cat2_child4_child8.children.create!(name: 'Prensagem permanente')
cat2_cat4_child8_child1 = cat2_child4_child8.children.create!(name: 'Resinagem')
cat2_cat4_child8_child1.children.create!(name: 'pvc')
cat2_cat4_child8_child1.children.create!(name: 'Acrílica')
cat2_cat4_child8_child1.children.create!(name: 'Termofixagem')
cat2_child5 = category2.children.create!(name: 'processos de materiais cerâmicos')
cat2_child5.children.create!(name: 'Prensagem')
cat2_child5.children.create!(name: 'Moldagem em barbotina (slip casting)')
cat2_child5.children.create!(name: 'Moldagem em fita (tape casting)')
cat2_child5.children.create!(name: 'Conformação plástica')
cat2_child5.children.create!(name: 'Moldagem por injeção')
